public class TestSinglyLinkedList {
    public static void main(String[] args) {
        ...
        System.out.println("quantidade de ocorrencias do 4 -> " + list.count(4));

        list.removeAll(6);
        System.out.println("lista com o 6 removidos = " + list);
        ...
        list.removeAll(3);
        System.out.println("lista com o 3 removidos = " + list);
