...
public class BTree<T> {
   ...
   // --------------------------------------------
   // retrona quantidade de filhos unicos
   public int count() {
      return count(root);
   }

   public int count(BTNode<T> nodo) {
      if (nodo == null)
         return 0;

      if ((nodo.getLeft() == null && nodo.getRight() != null) || (nodo.getLeft() != null && nodo.getRight() == null))
         return 1 + count(nodo.getLeft()) + count(nodo.getRight());

      return count(nodo.getLeft()) + count(nodo.getRight());
