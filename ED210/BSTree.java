...
public class BSTree<T extends Comparable<? super T>> {
   ...
   // ---------------------------------------------------------
   // retorna o valor minimo da arvore
   public T minValue() {
      return minValue(root);
   }

   public T minValue(BSTNode<T> nodo) {
      if (nodo.getLeft() == null)
         return nodo.getValue();
      return minValue(nodo.getLeft());
   }
   ...
   public T maxValue(BSTNode<T> nodo) {
   ...
   public boolean valid(BSTNode<T> nodo){
      if(nodo == null) return true;

      if((nodo.getValue()).comparTo(nodo.getRight().getValue()) > 0) ||
         (valor.comparTo(nodo.getLeft().getValue()) < 0)) return false;
      




      return (nodo.getValue().compareTo(valid(nodo.getLeft()) || valid );
   }
}
